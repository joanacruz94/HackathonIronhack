    ...
    return (
      <div>
        <div className="adviceDisplay">
          ...
          <div className="adviceBox">
            <img src="https://i.pinimg.com/originals/64/34/d7/6434d72ce9e16251c4f41f4e5a146567.png" />
            <h2>Doctors</h2>
            <p>
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
              has been the industry's standard dummy text ever since the 1500s, when an unknown
          ...
          <div className="adviceBox">
            <img src="https://cdn3.iconfinder.com/data/icons/communication-2-2/256/People_Communicating-512.png" />
